...
class Input {
    public static let Input1_rules = """
66: 69 116 | 9 115
91: 95 9 | 109 69
14: 110 69 | 15 9
4: 119 9 | 61 69
...
"""
    ...
    public static var Input2_rules: String {
        var result = ""

        let lines = Input1_rules.split(separator: "\n")
        for line in lines {
            let elements = line.split(separator: ":")
            let id = Int(String(elements[0]))!
            switch id {
            case 8:
                result += "8: 42 | 42 8\n"
            case 11:
                result += "11: 42 31 | 42 11 31\n"
            default:
                result += "\(line)\n"
            }
        }
...
"""
    ...
    public static let Example1_rules = """
0: 4 1 5
1: 2 3 | 3 2
2: 4 4 | 5 5
3: 4 5 | 5 4
...
"""
    ...
    public static let Example1_data = """
ababbb
bababa
abbbab
aaabbb
